...
if __name__ == '__main__':
    ...
    if os.path.exists(model_output_dir):
        ...
        # story_to_quiz = stories[0] # ตัวอย่าง: ใช้เรื่องแรกจากชุดข้อมูล
